  ...
  return (
    <div
        ...
        <div className='text-center p-4'>
            <p className='font-semibold text-xl text-white mt-8'>Our Services</p>
            <h3 className='text-3xl font-bold mt-6'>Our Medical Services</h3>
        </div>

        <div className='grid grid-cols-4 gap-0.5 p-10 mt-  max-w-4xl mx-auto justify-center rounded'>
          <div><img className='rounded-md w-48 h-48 text-center bg-white' src={Doc2} alt="" />
            <div className='bg-[#2DAF70] h-14 w-48 p-1'> 
          ...
          <div><img className='rounded-md w-48 h-48 bg-white' src={Doc1} alt="" />
            <div className='bg-[#2DAF70] h-14 w-48'>
              <p className='text-white ml-2'>Dr. Philip Tunder</p>
              <span className='text-white ml-2'>Cardiologist</span>
              <span className='w-32 h-9 bg-blue-500 rounded-full absolute top-[2500px]'>social media</span>
              </div>
          </div>
          ...
          <div><img className='rounded-md w-48 h-48 bg-white relative' src={Doc4} alt="" />
              <div className='bg-[#2DAF70] h-14 w-48'>
